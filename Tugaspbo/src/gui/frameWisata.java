...
public class frameWisata extends javax.swing.JFrame {
    ...
    crudDB mycrud;
    String fieldAlbum[]={"id_wisata","nama_wisata","deskripsi","gambar"};
    String judulkolom[]={"id_wisata","nama_wisata","deskripsi","gambar"};
    int lebarkolom[]={150,150,150,150};
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(txtIdWisata)
                            .addComponent(txtNamaWisata, javax.swing.GroupLayout.DEFAULT_SIZE, 171, Short.MAX_VALUE)))
                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                        .addGroup(layout.createSequentialGroup()
                            .addComponent(jLabel3)
                            .addGap(51, 51, 51)
                            .addComponent(txtDeskripsi, javax.swing.GroupLayout.PREFERRED_SIZE, 173, javax.swing.GroupLayout.PREFERRED_SIZE))
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            .addComponent(jLabel2)
                            .addComponent(txtNamaWisata, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGap(18, 18, 18)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            .addComponent(jLabel3)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        String isi[]={txtIdWisata.getText(),txtNamaWisata.getText(),txtDeskripsi.getText(),txtGambar.getText()};
      mycrud.SimpanDinamis("wisata", fieldAlbum, isi);// TODO add your handling code here:
      mycrud.tampilTabel(jTable1, Sql, judulkolom);
    ...
    String[] field = {"id_wisata","nama_wisata","deskripsi","gambar"};
    String[] value = {
        txtIdWisata.getText(), // Isi Berita
        txtNamaWisata.getText(), // Sumber
    ...
    if (id.isEmpty() || txtIdWisata.getText().isEmpty() || txtNamaWisata.getText().isEmpty() || txtDeskripsi.getText().isEmpty() || txtGambar.getText().isEmpty()  ) {
        javax.swing.JOptionPane.showMessageDialog(this, "Semua field diisi!");
        return;
    }

    // Panggil metode EditDinamis
    mycrud.EditDinamis("wisata", "id_wisata", id, field, value);
    ...
    if (konfirmasi == javax.swing.JOptionPane.YES_OPTION) {
        ...
        mycrud.HapusDinamis("wisata", "id_wisata", id);
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        if (carilaporan.getText().isEmpty()){
            ...
            sql="select*from wisata where id_wisata ='"+carilaporan.getText()+"'";
        }
        mycrud.tampilLaporan("C:\\Users\\adyat\\OneDrive\\Dokumen\\NetBeansProjects\\Tugaspbo\\src\\laporan\\wisata.jrxml", sql);
